	...
	for (const textureName in textures.textures) {
		...
		buildingSprite.on('pointerdown', () => {
			...
			if ((textureName === 'barracks.png') && !island.buildingMoment) {
				...
				{
					island.buildingMoment = true
					island.buldingObject = new Building(app, island.cells, island.buildingsOfUserIsland, island.buildings, island.quadTree, 'Barrack', 'barrack', {}, 1, 100, 0, 2, 25, requiredResources, island.resourcesOfUser, allTextResources, island.buildingCountsOfUser, containerForMap, dimensions, false, 0, idUser);
					island.buldingObject.setMatrixPattern([
						[1, 1, 0],
						[0, 1, 1],
						[0, 1, 1],
			...
			if ((textureName === 'tower.png') && !island.buildingMoment) {
				...
				{
					island.buildingMoment = true
					island.buldingObject = new Building(app, island.cells, island.buildingsOfUserIsland, island.buildings, island.quadTree, 'Tower', 'tower', {}, 1, 100, 0, 2, 29, requiredResources, island.resourcesOfUser, allTextResources, island.buildingCountsOfUser, containerForMap, dimensions, false, 20, idUser);
					island.buldingObject.setMatrixPattern([
						[0, 0, 0],
						[0, 1, 0],
						[0, 0, 0],

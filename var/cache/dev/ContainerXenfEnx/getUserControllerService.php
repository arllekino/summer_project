...
class getUserControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['App\\Controller\\UserController'] = $instance = new \App\Controller\UserController(new \App\Service\UserService(new \App\Repository\UserRepository(($container->services['doctrine.orm.default_entity_manager'] ?? $container->load('getDoctrine_Orm_DefaultEntityManagerService'))), ($container->privates['App\\Service\\PasswordHasher'] ?? ($container->privates['App\\Service\\PasswordHasher'] = new \App\Service\PasswordHasher()))), new \App\Controller\SessionController(($container->services['.container.private.session'] ?? $container->load('get_Container_Private_SessionService'))));

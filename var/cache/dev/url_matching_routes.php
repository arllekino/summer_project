...
return [
    ...
    [ // $staticRoutes
        ...
        '/make_player_not_ready' => [[['_route' => 'make_player_not_ready', '_controller' => 'App\\Controller\\LobbyPlaceController::makePlayerNotReady'], null, ['POST' => 0], null, false, false, null]],
        ...
        '/get_player_ids' => [[['_route' => 'get_ids_players', '_controller' => 'App\\Controller\\LobbyPlaceController::getPlayersIdsInLobby'], null, ['POST' => 0], null, false, false, null]],
